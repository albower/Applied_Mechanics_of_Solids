function FEM_shear_locking_demo
%
%
...
%       set up to demonstrate 'shear locking' in elongated
%       elements that are subjected to bending.
...
%
 ...
 %   Plot the exact solution    
     ...
     title({'Shear locking demonstration', 'Blue - exact solution; red - FEA'})
