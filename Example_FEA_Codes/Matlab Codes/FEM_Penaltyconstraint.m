...
%   Element data will be written to the file specified below
    ...
    [nprops,materialprops,ncoord,ndof,nnode,coords,nelem,maxnodes,connect,nelnodes,...
        elident,nfix,fixnodes,ndload,dloads,nties,ties,penaltystif] = read_input_file(infile);
    fclose(infile);
%    
%%
%   Analysis
    ...
    K = globalstiffness(ncoord,ndof,nnode,coords,nelem,maxnodes,elident,nelnodes,connect,materialprops,dofs,nties,ties,penaltystif);
...
set(axes1,'DataAspectRatio',[1 1 1],'FontName','Times','FontSize',16,...
 ...
 title('Penalty constraint demo','FontSize',15)
...
function kel = tiestiffness(ndof,dof1,dof2,penaltystif)
%
%    Computes stiffness to tie dof1 of node 1 to dof2 of node 2
%
   kel = zeros(2*ndof,2*ndof);
   kel(dof1,dof1) = penaltystif;
   kel(dof1,ndof+dof2) = -penaltystif;
   kel(ndof+dof1,dof2) = -penaltystif;
   kel(ndof+dof1,ndof+dof2) = penaltystif;
end
...
function Stif = globalstiffness(ncoord,ndof,nnode,coords,nelem,maxnodes,elident,nelnodes,connect,materialprops,dofs,nties,ties,penaltystif)
%
...
% Add the constraints to the global stiffness   
   for c = 1:nties
       dof1 = ties(2,c);
       dof2 = ties(4,c);
       ktie = tiestiffness(ndof,dof1,dof2,penaltystif);
       for a = 1:2
           for i = 1:ndof
...
%==============================Function read_input_file =================
 function [nprops,materialprops,ncoord,ndof,nnode,coords,nelem,maxnodes, ...
                connect,nelnodes,elident,nfix,fixnodes,ndload,dloads,nties,ties,penaltystif] = read_input_file(infile) 
