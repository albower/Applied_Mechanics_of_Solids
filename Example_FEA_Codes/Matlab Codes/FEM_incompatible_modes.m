...
%
%       The code is based on the general purpose 2D/3D linear elastic
%       finite element code FEM_2Dor3D_linelast_standard.m, but is
%       set up to demonstrate that 'shear locking' in elongated
%       elements that are subjected to bending can be avoided by means
%       of incompatible mode elements.
%       It calculates and plots the displacement field in an end-loaded
%       cantilever beam, and compares the finite element solution to the
%       exact solution.
%
...
%
filename = '../Input Files/shear_locking_demo.txt';
