...
%
filename = '';
%filename = '../Input Files/FEM_conststrain_holeplate.txt';
%filename = '../Input Files/FEM_conststrain_input.txt';
...
[E,nu,nnode,coord,nelem,connect,nfix,fixnodes,ndload,dloads] = read_file(infile);
fclose(infile);

close all
%%
% =============  Define the D matrix (plane strain) =======================
%
...
%
function [E,nu,nnode,coord,nelem,connect,nfix,fixnodes,ndload,dloads] = read_file(infile) 
...
%
nnode=str2double(cellarray{1}{7});
dum=9;
coord=zeros(nnode,2);
for i=1:nnode
