function FEM_Contact
%
%          Example nonlinear hypoelastic FEM code (with Bbar elements), extended to
%          include (nonlinear) finite sliding 2D contact elements
%          using a frictionless 'hard' contact model with constraints
...
%
%       It is set up to run with the input file Contact_example.txt
%       which sets up a simple simulation of contact between two rectangular
%       elements.
%       The simulation will plot the deformed mesh at the end of the
%       computation, and will print a file listing nodal displacements
%       as well as stresses and strains at the element integration points
%       
...
%        slavelist           List of slave nodes
%        nmaster             No. master nodes
%        masterlist          List of master nodes
%
%
...
%
    filename = '../Input Files/Contact_example.txt';
...
%  max_contact_it is the maximum number of iterations taken to identify
%  contacting slave nodes
    ...
    relax = 1.;
      ...
      for step = 1 : nsteps
         ...
         continue_contact_iterations = true;
          ...
          fprintf(1,'\n Step %f Load %f\n',step,loadfactor);
          while (continue_contact_iterations && n_contact_its<max_contact_it)
