function FEM_volumetric_locking_demo
%
%
...
%       set up to demonstrate 'volumetric locking' in a finite element
%       simulation with a near-incompressible material.
...
%
    ...
    a = coords(2,1);
     ...
     title({'Volumetric Locking Demo', 'Blue - exact solution; red - FEA'})
end
