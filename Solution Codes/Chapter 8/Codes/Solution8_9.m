...
%
    filename = '../Input Files/Solution8_9a.txt';
    filename = '../Input Files/Solution8_9b.txt';
...
%
   elseif (ncoord==3) 
     ...
     elseif (nelnodes==6)
       N(1) = xi(1)*(1-xi(3));
       N(2) = xi(2)*(1-xi(3));
       N(3) = (1.-xi(1)-xi(2))*(1-xi(3));
       N(4) = xi(1)*xi(3);
       N(5) = xi(2)*xi(3);
       N(6) = (1.-xi(1)-xi(2))*xi(3);       
     elseif (nelnodes == 10) 
