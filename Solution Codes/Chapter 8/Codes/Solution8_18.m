...
%        ndload              Total no. element faces subjected to tSoluractions
...
%
    filename = '../Input Files/Solution8_18.txt';
...
%
 % Plot the internal bore displacement as a function of time
 %
     figure1 = figure('NumberTitle','off','Name','Figure','Color',[1 1 1]); 
    ...
    set(axes3,'FontName','Times','FontSize',16,...
     ...
     plot(pforplot,uforplot,'LineStyle','-','Color','k','LineWidth',2,'Displayname','$n=1$')
     ylabel({'Displacememt $u_r(a)$'},'Interpreter','latex','FontSize',16);
     xlabel({'Pressure $p$'},'Interpreter','latex','FontSize',16);
     title('Displacement of pressurized cylinder')
