...
%
%
%       This code solves problem 8.25 from the text
...
%
    filename = '../Input Files/Solution8_25.txt'; 
%
...
%
    ...
    set(axes2,'FontName','Times','FontSize',16,...
        ...
        'Box','On');
      plot(forcevdisp(1,:),forcevdisp(2,:),'k','LineWidth',2);
  xlabel({'Strain $\varepsilon_{11}$'},'FontSize',16, 'Interpreter','latex');
  ylabel({'Stress $\sigma_{11}$'},'FontSize',16, 'Interpreter','latex');
  title('Stress-v-strain for viscoplastic solid','FontName','Times','FontSize',16)
