...
%
%       This code solves problem 8.36(b) and 8:36(c) from the text
...
%
    filename = '../Input Files/Solution8_36b.txt';
...
%
    ...
    deflection = u(6*loads(1,1)-4);
    disp(['Deflection of load point: ',num2str(deflection)])
    
    scale = 30;
    if (solvepartc) scale = 200; end
    ...
    axis equal
    title('Deflection of center loaded arch')
