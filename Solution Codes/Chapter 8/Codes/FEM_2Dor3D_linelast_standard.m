...
%    editor window)
%
%    You can test the code with the following demonstration input files
...
% Linear_elastic_brick8.txt: 3D problem with 4 noded brick element;
% Linear_elastic_brick20.txt: 3D problem with 20 noded brick element
% Linear_elastic_pressurized_cylinder.txt: 2D simulation of a pressurized cylinder (4 noded elements);
%
%%
...
%
filename = '';
%filename = '../Input Files/Linear_elastic_triangles.txt';
%filename = '../Input Files/Linear_elastic_quad4.txt';
%filename = '../Input Files/Linear_elastic_quad8.txt';
%filename = '../Input Files/Linear_elastic_brick8.txt';
%filename = '../Input Files/Linear_elastic_brick20.txt';
%filename = '../Input Files/Linear_elastic_pressurized_cylinder.txt';
