function Solution8_30
%
%
%          Example 2D and 3D hypoelastic FEM code 
%
%
%       This code solves problem 8.30 from the text
...
%
    filename = '../Input Files/Solution8_30.txt';
...
%
    ...
    for cases = 1:2  % Compares solutions with full and reduced integration
        w = zeros(nnode*ndof,1);
        if (cases==2)
            elident(:) = elident(:) + 10; % Activate reduced integration
        end
        for step = 1 : nsteps
...
%      Print nodal displacements, element strains && stresses to a file
    ...
    set(axes2,'FontName','Times','FontSize',16,...
     ...
     plot(pforplot(:,2),uforplot(:,2),'LineStyle','-','Color','k','LineWidth',2,'Displayname','Reduced Integration')
     ...
     set(legend1,...
         'Position',[0.213925022642627 0.668650799469354 0.387923776771483 0.219444438625891],...
         'Interpreter','latex',...
         'FontSize',14,...
