...
## Problem sets
Example problems (without solutions) in pdf format.  The problems with solutions are also published in A.F. Bower 'Solved Problems in Applied Mechanics of Solids' CRC press, Baton Rouge, 2026 
